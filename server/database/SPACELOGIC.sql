...
SET @org_id = (SELECT id FROM organisations WHERE nom = 'Gucci Gang');

-- Insert user with organisation ID
INSERT INTO users (nom, prenom, email, password, org_id)
...
VALUES ((SELECT id FROM projects WHERE numero ='GLO-2005'),@user_id_Seb);